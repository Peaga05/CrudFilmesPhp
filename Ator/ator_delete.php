...
if (isset($_POST["btn-excluir"])) {
  ...
  WHERE id = $atorId;";
    ...
    if ($resultado) {
        ...
        $resposta = "Erro ao deletar o ator.";
    }
}
$db->fecharConexao();
?>
...
<div class="d-flex justify-content-center align-items-center vh-100">
    <form method="post" class="text-center w-50">
        <h2 class="text-center">
            Tem certeza que deseja excluir o ator: <?php echo $nome; ?> ?
        </h2>
...
<div class="d-flex justify-content-center align-items-center vh-100">
    <form method="post" class="text-center w-50">
        <h2 class="text-center mt-5">
            Não é possível remover o ator <?php echo $nome; ?>, pois ele atua em um filme!
        </h2>
        <div class="text-center">
            <a id="btn-voltar" class="btn btn-outline-danger w-25 m-3" name="btn-voltar" href="./ator.php">Cancelar</a>
        </div>
